using AutoMapper;
using EMApp.Common.Mapping;
using EMApp.Data.Contracts;
using EMApp.Data.DataContext;
using EMApp.Data.Ýmplementaion;
...
namespace EMApp.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EMAppContext>(options => options.UseSqlServer(Configuration.GetConnectionString("IdentityConnection")));
